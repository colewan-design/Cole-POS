...
const orderTypeOptions: { value: 'dine_in' | 'takeaway'; label: string }[] = [
  { value: 'dine_in', label: 'Walk-in' },
  { value: 'takeaway', label: 'Appointment' },
]
...
function setOrderType(type: 'dine_in' | 'takeaway') {
...
<template>
  <aside class="order-panel">
    ...
    <div class="order-panel__fields order-panel__fields--single">
      <AutocompleteSelect
        flat
        :model-value="store.orderType"
        label="Order type"
        :options="orderTypeOptions"
        @update:model-value="setOrderType"
      />
    </div>
