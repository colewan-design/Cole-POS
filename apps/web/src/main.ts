...
import { readStaffTenant } from '@pos/web/tenantBinding'
...
const repository = createBrowserPosRepository({
  sync: {
    ...
    organizationSlug: boundTenant?.organizationSlug ?? import.meta.env.VITE_POS_ORGANIZATION_SLUG,
    storeCode: boundTenant?.storeCode ?? import.meta.env.VITE_POS_STORE_CODE,
