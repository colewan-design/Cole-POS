  ...
  <div class="landing">
      ...
      <div class="lp-hero">
        ...
        <div class="lp-hero-visual">
          <div class="lp-hero-image-frame hero-in--scale" style="animation-delay:420ms">
            <WebglTiltImage src="/hero.jpg" alt="Cole POS running on an iPad in a coffee shop" />
          </div>
    ...
    <section id="modes" class="lp-section lp-section--surface">
      <div class="lp-container">
        ...
        <div
          class="lp-demo-window lp-demo-window--tilt"
          :style="{
        ...
        >
          <div class="lp-demo-window__bar">
            <span class="lp-demo-dot" style="background:#ff5f57"></span>
            <span class="lp-demo-dot" style="background:#febc2e"></span>
            <span class="lp-demo-dot" style="background:#28c840"></span>
            <span class="lp-demo-window__title">Cole POS — Live Register</span>
          </div>
          <div class="app-demo-frame lp-demo-window__body">
    ...
    <section id="features" class="lp-section">
      <div class="lp-container">
        ...
        <div class="lp-bento-grid">
          <div v-reveal="0" class="lp-bento-cell lp-bento-cell--big reveal--scale">
            <div class="lp-bento-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--accent)" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg></div>
          ...
          <div v-reveal="70" class="lp-bento-cell lp-bento-cell--big reveal--scale">
            <div class="lp-bento-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#3a6fd8" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 6v16l7-4 8 4 7-4V2l-7 4-8-4-7 4z"/><path d="M8 2v16M16 6v16"/></svg></div>
            <div class="lp-bento-title">Works offline</div>
            <p class="lp-bento-desc">Local-first. Your register keeps running without internet and syncs automatically when back online.</p>
          </div>
          <div v-reveal="140" class="lp-bento-cell reveal--scale">
            <div class="lp-bento-icon"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--success)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg></div>
            <div class="lp-bento-title lp-bento-title--sm">Smart inventory</div>
            <p class="lp-bento-desc lp-bento-desc--sm">Track by unit or weight. Low-stock alerts before you run out.</p>
          </div>
          <div v-reveal="210" class="lp-bento-cell reveal--scale">
            <div class="lp-bento-icon"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#af52de" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg></div>
            <div class="lp-bento-title lp-bento-title--sm">Live analytics</div>
            <p class="lp-bento-desc lp-bento-desc--sm">Revenue, orders, and top products — on one screen, always current.</p>
          </div>
          <div v-reveal="280" class="lp-bento-cell reveal--scale">
            <div class="lp-bento-icon"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--warning)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/></svg></div>
            <div class="lp-bento-title lp-bento-title--sm">Multi-role access</div>
            <p class="lp-bento-desc lp-bento-desc--sm">Admin, Manager, Cashier — staff see exactly what they need.</p>
          </div>
          <div v-reveal="350" class="lp-bento-cell reveal--scale">
            <div class="lp-bento-icon"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--danger)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg></div>
            <div class="lp-bento-title lp-bento-title--sm">Flexible payments</div>
            <p class="lp-bento-desc lp-bento-desc--sm">Cash, card, and e-wallet. Change calculated automatically.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="analytics" class="lp-section lp-section--surface">
      <div class="lp-container">
        ...
        <div v-reveal class="lp-demo-window lp-demo-window--analytics reveal--scale reveal--lift">
          <div class="lp-demo-window__bar">
            <span class="lp-demo-dot" style="background:#ff5f57"></span>
            <span class="lp-demo-dot" style="background:#febc2e"></span>
            <span class="lp-demo-dot" style="background:#28c840"></span>
            <span class="lp-demo-window__title">Cole POS — Analytics</span>
          </div>
    ...
    <section id="how" class="lp-section">
      <div class="lp-container">
        ...
        <div v-reveal class="lp-steps-grid">
          <span class="lp-steps-line" aria-hidden="true"></span>
          <div v-reveal="0" class="lp-step">
            <div class="lp-step-number">1</div>
            <div class="lp-step-visual">
              <span class="lp-step-chip" style="background:var(--accent)">Coffee</span>
              <span class="lp-step-chip" style="background:var(--success)">Grocery</span>
              <span class="lp-step-chip" style="background:var(--warning)">Restaurant</span>
            </div>
          ...
          <div v-reveal="150" class="lp-step">
            <div class="lp-step-number">2</div>
            <div class="lp-step-visual">
              <div class="lp-csv-row">
                <div class="lp-csv-cell">Name</div>
                <div class="lp-csv-cell">Price</div>
                <div class="lp-csv-cell">Stock</div>
                <div class="lp-csv-cell">SKU</div>
              </div>
            </div>
          ...
          <div v-reveal="300" class="lp-step">
            <div class="lp-step-number">3</div>
            <div class="lp-step-visual">
              <div class="lp-reg-row">
                <div class="lp-reg-item">Latte ×2</div>
                <div class="lp-reg-item">Muffin</div>
                <div class="lp-reg-total">$15.50 →</div>
              </div>
            </div>
...
.lp-hero {
  ...
  max-width: 1200px; margin: 0 auto; min-height: calc(100vh - 56px);
}
...
.lp-hero-visual { position: relative; align-self: stretch; display: flex; align-items: flex-end; }
.lp-hero-image-frame {
  width: 100%; border-radius: 28px 28px 0 0; overflow: hidden;
  box-shadow: 0 32px 80px rgba(0,0,0,0.13), 0 8px 24px rgba(0,0,0,0.06);
  background: var(--bg-elevated); aspect-ratio: 4/5; position: relative;
}
.lp-hero-chip {
  position: absolute; bottom: 28px; left: -28px; background: var(--bg-surface);
  border: 1px solid var(--separator); border-radius: 22px; padding: 16px 20px;
  box-shadow: 0 20px 60px rgba(0,0,0,0.10), 0 4px 12px rgba(0,0,0,0.05);
  display: flex; align-items: center; gap: 14px; z-index: 2;
}
.lp-chip-icon { width: 40px; height: 40px; border-radius: 12px; background: var(--accent-light); display: flex; align-items: center; justify-content: center; color: var(--accent); flex-shrink: 0; }
.lp-chip-value { font-size: 22px; font-weight: 800; letter-spacing: -0.04em; line-height: 1; }
.lp-chip-label { font-size: 12px; color: var(--text-secondary); margin-top: 3px; }

/* ── Floating feature cards (mini real-component mockups, not text bubbles) ── */
.lp-float-card {
  position: absolute; z-index: 2; width: 236px; background: var(--bg-surface);
  border: 1px solid var(--separator); border-radius: 20px; overflow: hidden;
  box-shadow: 0 26px 76px rgba(0,0,0,0.14), 0 6px 16px rgba(0,0,0,0.06);
}
.lp-float-bar { display: flex; align-items: center; gap: 7px; padding: 11px 14px; background: #e4e7ea; }
.lp-float-dot { width: 9px; height: 9px; border-radius: 50%; }
.lp-float-body { padding: 14px 15px 16px; display: flex; flex-direction: column; gap: 9px; }
.lp-float-pill {
...
.lp-float-pill-dot { width: 9px; height: 9px; border-radius: 50%; flex-shrink: 0; }
.lp-float-title { font-size: 15px; font-weight: 600; color: var(--text-secondary); padding: 0 15px 15px; }
.lp-float-title--center { text-align: center; }

.lp-float-card--modes { top: 30px; right: -54px; }

.lp-float-card--analytics { top: 46%; left: -56px; }
.lp-float-body--analytics { flex-direction: row; align-items: flex-end; gap: 14px; padding: 18px 16px 8px; }
.lp-float-donut {
  width: 46px; height: 46px; border-radius: 50%; flex-shrink: 0;
  background: conic-gradient(var(--accent) 0% 40%, var(--success) 40% 70%, var(--warning) 70% 100%);
}
.lp-float-chart { display: flex; align-items: flex-end; gap: 6px; height: 50px; flex: 1; }
.lp-float-bar-el { flex: 1; border-radius: 4px 4px 0 0; min-height: 5px; }

.lp-float-card--payments { bottom: 110px; right: -38px; width: 210px; }
.lp-float-body--payments { flex-direction: row; justify-content: center; gap: 11px; padding: 18px 16px 13px; }
.lp-float-pay-icon {
  width: 44px; height: 44px; border-radius: 13px; background: var(--accent-light);
...
.lp-demo-window { border-radius: 18px; overflow: hidden; border: 1px solid var(--separator); box-shadow: 0 20px 60px rgba(0,0,0,0.10), 0 4px 12px rgba(0,0,0,0.05); }
...
.lp-demo-window__bar { display: flex; align-items: center; gap: 7px; padding: 11px 14px; background: #e4e7ea; }
.lp-demo-dot { width: 11px; height: 11px; border-radius: 50%; }
.lp-demo-window__title { margin-left: 10px; font-size: 12.5px; font-weight: 600; color: #5b6470; }
.lp-demo-window__body { padding: 16px; max-height: 720px; overflow: auto; }
.lp-demo-window__body--analytics { max-height: none; overflow: visible; }
...
.lp-demo-window--analytics.reveal-visible :deep(.donut-chart) { opacity: 1; transform: scale(1); }

.lp-demo-window--analytics :deep(.hbar-fill) { transform: scaleX(0); transform-origin: left; transition: transform 0.7s var(--ease-out); }
.lp-demo-window--analytics.reveal-visible :deep(.hbar-fill) { transform: scaleX(1); }
...
.lp-demo-window--analytics.reveal-visible :deep(.product-rank-row) { opacity: 1; transform: none; }
...
.lp-demo-window--analytics.reveal-visible :deep(.rank-bar-fill) { transform: scaleX(1); }
...
.lp-demo-window--analytics.reveal-visible :deep(.hour-bar) { transform: scaleY(1); }
...
/* ── Bento features ────────────────────────────────────────────────── */
.lp-bento-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 14px; }
...
.lp-bento-cell--big { grid-column: span 2; }
.lp-bento-icon {
  width: 44px; height: 44px; border-radius: 12px; border: 1px solid var(--separator); background: var(--bg-base);
...
.lp-bento-title { font-size: 17px; font-weight: 700; letter-spacing: -0.02em; }
.lp-bento-title--sm { font-size: 15px; }
.lp-bento-desc { font-size: 14px; color: var(--text-secondary); line-height: 1.6; margin: 0; }
.lp-bento-desc--sm { font-size: 13px; }

/* ── Steps ─────────────────────────────────────────────────────────── */
.lp-steps-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 0; position: relative; }
.lp-steps-grid.reveal { opacity: 1; transform: none; }
.lp-steps-line {
  position: absolute; top: 19px; left: calc(100% / 6); right: calc(100% / 6); height: 2px;
  background: var(--separator-strong); transform: scaleX(0); transform-origin: left;
  transition: transform 1s var(--ease-out) 0.2s; z-index: 0;
}
.lp-steps-grid.reveal-visible .lp-steps-line { transform: scaleX(1); }
.lp-step { padding-right: 32px; }
.lp-step-number {
  position: relative; z-index: 1;
  width: 40px; height: 40px; border-radius: 50%; background: var(--bg-surface);
  border: 1.5px solid var(--separator-strong); display: flex; align-items: center; justify-content: center;
  font-size: 14px; font-weight: 800; margin-bottom: 24px;
  opacity: 0; transform: translateY(8px); transition: opacity 0.4s ease, transform 0.4s var(--ease-out);
}
.lp-step.reveal-visible .lp-step-number { opacity: 1; transform: none; }
.lp-step-visual {
  background: var(--bg-surface); border: 1px solid var(--separator); border-radius: 16px; padding: 16px; margin-bottom: 20px; min-height: 80px; display: flex; align-items: center; justify-content: center; gap: 8px;
  opacity: 0; transform: scale(0.92); transition: opacity 0.5s ease 0.15s, transform 0.5s var(--ease-out) 0.15s;
}
.lp-step.reveal-visible .lp-step-visual { opacity: 1; transform: none; }
.lp-step-title { font-size: 17px; font-weight: 700; letter-spacing: -0.02em; margin: 0 0 10px; }
.lp-step-desc { font-size: 14px; color: var(--text-secondary); line-height: 1.65; margin: 0; }
.lp-step-chip { padding: 6px 12px; border-radius: 980px; font-size: 11px; font-weight: 700; color: #fff; }
.lp-csv-row { display: flex; gap: 6px; }
.lp-csv-cell { padding: 4px 8px; background: var(--bg-base); border: 1px solid var(--separator); border-radius: 4px; font-size: 10px; font-weight: 500; }
.lp-reg-row { display: flex; gap: 6px; align-items: center; }
.lp-reg-item { padding: 6px 12px; background: var(--bg-base); border: 1px solid var(--separator); border-radius: 12px; font-size: 11px; font-weight: 600; }
.lp-reg-total { padding: 6px 14px; background: var(--accent); color: #fff; border-radius: 12px; font-size: 12px; font-weight: 700; }
...
/* ── Footer ────────────────────────────────────────────────────────── */
.lp-footer { padding: 36px 40px; background: var(--marketing-dark); border-top: 1px solid rgba(255,255,255,0.06); display: flex; align-items: center; justify-content: space-between; }
...
@media (max-width: 1020px) {
  ...
  .lp-bento-cell--big { grid-column: span 1; }
}
